		...
		<div id="list-post" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="datePublished" title="${message(code: 'post.datePublished.label', default: 'Date Published')}" />
				...
				<g:each in="${postInstanceList}" status="i" var="postInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${postInstance.datePublished}" /></td>
