	...
	<body>
		...
		<div id="show-post" class="content scaffold-show" role="main">
			...
			<ol class="property-list post">
				...
				<g:if test="${postInstance?.datePublished}">
				<li class="fieldcontain">
					<span id="datePublished-label" class="property-label"><g:message code="post.datePublished.label" default="Date Published" /></span>
					
						<span class="property-value" aria-labelledby="datePublished-label"><g:formatDate date="${postInstance?.datePublished}" /></span>
